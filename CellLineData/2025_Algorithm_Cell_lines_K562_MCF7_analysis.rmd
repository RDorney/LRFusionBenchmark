...
Find "Mitochondrial:Genomic" fusions chrM x genomic genes, and "Mitochondrial" chimeras and 
filter misalignments and fusions between self, e.g. paralogus genes fused 
```{r}
source("~/LongReadFusionCallerBenchmark/CellLineData/Mito_Chimeras_SGNex.R")
```
