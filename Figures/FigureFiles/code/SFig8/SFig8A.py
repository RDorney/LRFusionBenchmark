"""Supplementary Figure 8A. Precision in relation to minimum read support.
...
read-support threshold on a log scale and the y-axis is precision, with one line
per caller. Partially recalled fusions are counted as false positives. This is
the per-condition companion to Fig3A: raising the threshold removes low-support
calls and lifts precision, and the grid shows how that response varies with depth
and identity.
"""
...
METRIC, YLABEL, YLIM = 'Precision', 'Precision', (-0.044, 1.05)
YTICKS = [0, 0.25, 0.5, 0.75, 1.0]
TITLE = 'Precision in relation to minimum read support'
