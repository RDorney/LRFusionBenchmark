...
```
```{r}
ggplot(filter(fusion_profile_stat_summary,
            recall_category == "False_Call"), aes( x = Sequence_Identity, y = depth, 
                   colour = Algorithm, size = fusion_type_count))+
  geom_jitter(height = 0.05, width = 0.3)+
  facet_grid(fusionType~control)
  
ggplot(filter(fusion_profile_stat_summary,
            recall_category == "Partial_Recall",
            control == "positive"), aes( x = Sequence_Identity, y = depth, 
                   colour = Algorithm, size = fusion_type_count))+
  geom_jitter(height = 0.05, width = 0.3)+
  facet_wrap(~fusionType, ncol = 2)
