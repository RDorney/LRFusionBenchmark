...
write_tsv(JAFFAL_sensecheck_annotated, file = "/bioinformatics/ryley/Gencode44/Huh7_Library/JAFFAL_Huh7_sensecheck.tsv.gz")
...
write_tsv(JAFFAL_sensecheck_annotated_collapsed, file = "/bioinformatics/ryley/Gencode44/Huh7_Library/JAFFAL_Huh7_sensecheck_collapsed.tsv.gz")
