...
LR_sequencing <- read.csv("/bioinformatics/ryley/Library_Benchmark/JAFFAL_Huh7_gv44/JAFFAL_Huh7_genCode44/jaffa_results.csv", header = TRUE) %>% 
...
Illumina_sequencing_IllHB1<- read.csv("/bioinformatics/ryley/Library_Benchmark/JAFFA_direct_gencode44/Huh7B1/jaffa_results_Huh7B1.csv", header = TRUE) %>% 
  mutate(library_type = "PCR_cDNA",           
         RNA_sample = "B1",
         Platform = "Illumina")
Illumina_sequencing_IllHB2<- read.csv("/bioinformatics/ryley/Library_Benchmark/JAFFA_direct_gencode44/Huh7B2/jaffa_results_Huh7B2.csv", header = TRUE) %>% 
  mutate(library_type = "PCR_cDNA",
         RNA_sample = "B2",
         Platform = "Illumina")
...
LRTri_gene <- list.files(path="/bioinformatics/ryley/Library_Benchmark/JAFFAL_Huh7_gv44", pattern = "3gene_summary", full.names = TRUE, recursive = TRUE) 
name <- 0
